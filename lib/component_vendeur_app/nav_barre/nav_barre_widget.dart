...
class NavBarreWidget extends StatefulWidget {
  const NavBarreWidget({
    super.key,
    int? number,
  ...
  @override
  State<NavBarreWidget> createState() => _NavBarreWidgetState();
}

class _NavBarreWidgetState extends State<NavBarreWidget> {
  late NavBarreModel _model;
