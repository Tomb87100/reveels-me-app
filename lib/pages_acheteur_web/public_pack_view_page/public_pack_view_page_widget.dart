...
import '/components/checkout_bottom_sheet_widget.dart';
...
class PublicPackViewPageWidget extends StatefulWidget {
  ...
  State<PublicPackViewPageWidget> createState() =>
      _PublicPackViewPageWidgetState();
}

class _PublicPackViewPageWidgetState extends State<PublicPackViewPageWidget> {
  late PublicPackViewPageModel _model;
                            ...
                            children: [
                              Align(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image.asset(
                                    'assets/images/SCR-20250611-otkf.png',
                                    width: 300.0,
                                    fit: BoxFit.contain,
                                  ),
                                ),
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Flexible(
                                    child: Text(
                                      'Frais de confidentialité et de sécurité et taxes',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            font: GoogleFonts.inter(
                          ...
                          Flexible(
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  20.0, 0.0, 20.0, 0.0),
                              child: Text(
                                'Le moyen le plus rapide, le plus sûr et le plus privé de vendre des médias.',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.inter(
