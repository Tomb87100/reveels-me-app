...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? SelectMediaPageWidget() : Auth1Widget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: SelectMediaPageWidget.routeName,
          path: SelectMediaPageWidget.routePath,
          builder: (context, params) => SelectMediaPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: ConfigurePackPageWidget.routeName,
          path: ConfigurePackPageWidget.routePath,
          builder: (context, params) => ConfigurePackPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: MyPacksPageWidget.routePath,
        ...
        FFRoute(
          name: FinancialsHistoryPageWidget.routeName,
          path: FinancialsHistoryPageWidget.routePath,
          builder: (context, params) => FinancialsHistoryPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          path: InfosPersoWidget.routePath,
          builder: (context, params) => InfosPersoWidget(),
        ),
        FFRoute(
