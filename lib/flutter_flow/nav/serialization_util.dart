  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case PackStatsViewRow:
            return PackStatsViewRow(data);
          case PacksRow:
          ...
          case StripeWebhooksRow:
            return StripeWebhooksRow(data);
          case PayoutRequestsRow:
            return PayoutRequestsRow(data);
          case SaleItemsRow:
            return SaleItemsRow(data);
          case SalesRow:
            return SalesRow(data);
          case SellerFinancialSummaryViewRow:
