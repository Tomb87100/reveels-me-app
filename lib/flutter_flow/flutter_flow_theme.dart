...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF003E45);
  late Color secondary = const Color(0xFF092429);
  late Color tertiary = const Color(0xFFD3080B);
  late Color alternate = const Color(0xFFD3080B);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF999999);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF4F4F4);
  late Color accent1 = const Color(0xFFD3080B);
  late Color accent2 = const Color(0xFFD3080B);
  late Color accent3 = const Color(0xFFD3080B);
  late Color accent4 = const Color(0xFFD3080B);
  late Color success = const Color(0xFFD3080B);
  late Color warning = const Color(0xFFD3080B);
  late Color error = const Color(0xFFD3080B);
  late Color info = const Color(0xFFD3080B);
}
